...
public class GridChromeDragAndDrop {
	...
	public void setUp() throws MalformedURLException {
		...
		options.setCapability("browser_version", "8.0.4472.77");
		
		
		driver = new RemoteWebDriver(new URL("http://192.168.1.11:4444/wd/hub"), options);
